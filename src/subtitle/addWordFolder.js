...
// setInterval(() => {
//   const mysqlQuery =
//     "SELECT id FROM videos_all WHERE statusTest = 'false' AND statusSub='subtitleSaved'  ORDER BY viewes DESC";
...
//   try {
//     const sqlQuery = "UPDATE videos_all SET statusTest=? WHERE id=?";
//     db.query(sqlQuery, [1, objWords], (err, result) => {
//       if (err) {
//         console.log(err);
//         // reject(err);
